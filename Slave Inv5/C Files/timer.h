...
#define TIMER_STATE_EXT_FLT		4
#define TIMER_STATE_IPH1_FLT	5
#define TIMER_STATE_IPH2_FLT	6
#define TIMER_STATE_IPH3_FLT	7
#define TIMER_STATE_TEMP_FLT	8
